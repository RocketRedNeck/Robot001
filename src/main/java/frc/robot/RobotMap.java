...
public class RobotMap
{
    ...
    final public static IdGroup DRIVE_MOTOR_LEFT_ID_GROUP = new IdGroup(DRIVE_MOTOR_LEFT_A_ID,
                                                                        DRIVE_MOTOR_LEFT_B_ID);

    final public static IdGroup DRIVE_MOTOR_RIGHT_ID_GROUP = new IdGroup(DRIVE_MOTOR_RIGHT_A_ID,
